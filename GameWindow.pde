class GameWindow extends Window {
  ...
  float[] easyBeats = {1000,1000,2000,1000,1000, 2000,1000,500,500,2000,1000,500,500,  2000,1000,1000,1000,500,500,1000,1000,1000,500,500,
                      4000,1000,250,250,500,500,250,250,500, 2500,1000,1000,2000,1000,1000,2000,1000,1000, 1000,500,500, 2000,500,500,500,500,500};
  ...
  GameWindow(PApplet project) {
    ...
    scoreThreshold[0] = 300; //hard
    scoreThreshold[1] = 200; //easy
    maxScore = new int[2];
